# 베리타스 강좌 2: 인간의 이해 - 교과목 개발 프로젝트

## 프로젝트 개요

**과제명**: 『베리타스 강좌 2: 뇌과학-심리학-언어인지과학으로 본 인간의 이해』
**영문명**: Veritas Lecture 2: Understanding Humans Through Neuroscience, Psychology, and Cognitive Science
...
├── 00proposals/                       # 📝 연구 제안서
│   ├── current/                       # ⭐ 최신 버전 (v8)
│   │   ├── _연구개발계획서_v8_전생애최종본.md   # 최신 마크다운 (편집용)
│   │   └── _연구개발계획서_v8_전생애최종본.docx # 최신 워드 (제출용)
│   ├── versions/                      # 📚 이전 버전들
│   │   ├── _연구개발계획서_v3_최종.md
│   │   ├── _연구개발계획서_v2_공식양식.md
│   │   ├── _연구개발계획서_v1.md
...
- **제안서 (워드)**: `00proposals/current/_연구개발계획서_v8_전생애최종본.docx`
- **제안서 (마크다운)**: `00proposals/current/_연구개발계획서_v8_전생애최종본.md`
...
### v8 (2025-10-22) - 현재 최신 버전

- ✅ **전생애 통합**: 영유아부터 고령기까지 전생애 정신건강 모델 확장
- ✅ **AI-CoScientist**: AI 과학 탐구 인프라 및 윤리 거버넌스 통합
- ✅ **지역사회 연계**: 서울시/교육청 정책 제안 및 파트너십 강화
...
**최종 수정**: 2025-10-22 (v8 업데이트 반영: 2025-12-19)
**문서 버전**: v8 (Lifespan + AI-CoScientist 통합)
